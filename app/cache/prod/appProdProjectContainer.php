...
class appProdProjectContainer extends Container
{
    ...
    {
        require_once 'D:/xampp/htdocs/Symfony/app/cache/prod/jms_diextra/doctrine/EntityManager_50eff4c920a30.php';
        $a = new \Doctrine\Common\Cache\ArrayCache();
        $a->setNamespace('sf2orm_default_e41e449f81122f3878db65888887f66c');
        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_e41e449f81122f3878db65888887f66c');
        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_e41e449f81122f3878db65888887f66c');
        ...
        return $this->services['doctrine.orm.default_entity_manager'] = new \EntityManager50eff4c920a30_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager($e, $this);
    }
    ...
    protected function getJmsDiExtra_Metadata_MetadataFactoryService()
    {
        ...
        $instance->setCache(new \Metadata\Cache\FileCache('D:/xampp/htdocs/Symfony/app/cache/prod/jms_diextra/metadata'));
        return $instance;
    }
    ...
    protected function getTwigService()
    {
        ...
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => false, 'strict_variables' => false, 'exception_controller' => 'Symfony\\Bundle\\TwigBundle\\Controller\\ExceptionController::showAction', 'cache' => 'D:/xampp/htdocs/Symfony/app/cache/prod/twig', 'charset' => 'UTF-8', 'paths' => array()));
    ...
    protected function getSecurity_Access_DecisionManagerService()
    {
        ...
        $a->setCacheDir('D:/xampp/htdocs/Symfony/app/cache/prod/jms_security/expressions');
    ...
    {
        $this->services['security.extra.metadata_factory'] = $instance = new \Metadata\MetadataFactory(new \Metadata\Driver\LazyLoadingDriver($this, 'security.extra.metadata_driver'), new \Metadata\Cache\FileCache('D:/xampp/htdocs/Symfony/app/cache/prod/jms_security', false));
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'swiftmailer.spool.memory.path' => 'D:/xampp/htdocs/Symfony/app/cache/prod/swiftmailer/spool',
            ...
            'jms_aop.cache_dir' => 'D:/xampp/htdocs/Symfony/app/cache/prod/jms_aop',
            ...
            'jms_di_extra.cache_dir' => 'D:/xampp/htdocs/Symfony/app/cache/prod/jms_diextra',
            'jms_di_extra.doctrine_integration' => true,
            'jms_di_extra.doctrine_integration.entity_manager.file' => 'D:/xampp/htdocs/Symfony/app/cache/prod/jms_diextra/doctrine/EntityManager_50eff4c920a30.php',
            'jms_di_extra.doctrine_integration.entity_manager.class' => 'EntityManager50eff4c920a30_546a8d27f194334ee012bfe64f629947b07e4919\\__CG__\\Doctrine\\ORM\\EntityManager',
            ...
            'security.extra.cache_dir' => 'D:/xampp/htdocs/Symfony/app/cache/prod/jms_security',
